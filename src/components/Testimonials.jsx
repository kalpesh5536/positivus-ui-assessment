  ...
  return (
    <>
      <section className="mx-auto container px-8 py-12">
        ...
        <div className="bg-[#191A23] text-white  py-12 my-12 mb-0 rounded-3xl">
          <div className="overflow-hidden px-8">
            ...
            >
              {testimonials.map(({ id, review, author, position }) => (
                ...
                >
                  <div className="tooltip border border-[#B9FF66] p-5 rounded-3xl testimonial-box text-white">
          ...
          <div className="flex justify-center items-center gap-4 pt-20">
            ...
            {[...Array(testimonials.length)].map((_, i) => (
              <PiStarFourFill
                key={i}
                className={
                  i === activeIndex ? 'text-[#B9FF66] rotate-45' : 'text-[#F3F3F3] rotate-45'
                }
              />
            ))}
